...
export declare type PropsType<FormSpec extends FormSpecBase, DerivedState> = {
...
export declare class ReactComponent<FormSpec extends FormSpecBase, DerivedState> extends React.Component<PropsType<FormSpec, DerivedState>, StateType<FormSpec, DerivedState>> {
