...
class RxJSStateManager {
    constructor(args) {
        const { initialValues, fieldsSpec, externalStateStream, toStreamValidator, } = args;
        ...
        this.derivedStateStream = toStreamValidator(this.formStateStream, this.eventStreams, externalStateStream).pipe(tap_1.tap(derivedState => this.derivedState = derivedState));
